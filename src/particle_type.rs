...
impl ParticleType {
    pub fn from_random(color: sdl2::pixels::Color, type_count: usize, max_pulling_acc: f64, max_pushing_acc: f64, max_radius: f64, conversion_type: ConversionType, rng: &mut impl rand::Rng) -> Self {
